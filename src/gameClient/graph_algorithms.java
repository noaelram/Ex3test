...
public interface graph_algorithms {
	 ...
	 * Note: this is NOT the classical traveling salesman problem, as you can visit
	 * a node more than once, and there is no need to return to source node - just a
	 * simple path going over all nodes in the list.
	 * 
	 * @param targets
	 * @return
	 */
